...
### My self
  Smurf เป็นการโจมตีเครือข่ายโดยใช้ ICMP จัดการเครือข่ายทำให้เครือข่ายล่มหรือทำงานผิดปกติ คือการโจมตีโดยใช้วิธีส่งคำขอ(ping)ไปยังหลายๆเครื่องในเครือข่ายเป้าหมาย คือจะแปลงที่อยู่(IP)ของผู้โจมตีให้เหมือนกับที่อยู่ของเป้าหมาย ทำให้เครื่องต่างๆในเครื่อข่ายตอบกลับไปที่เป้าหมายแทน ก็คือเป้าหมายจะได้รับคำตอบจากหลายๆเครื่องพร้อมกันจนเครื่องรับทราฟฟิกจำนวนมากเกินจนทำงานไม่ได้หรือช้าลง 
